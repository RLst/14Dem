...
namespace LeMinhHuy
{
	...
	public sealed class UltraStateMachine : MonoBehaviour
	{
		...
		//Events
		[Space]
		public UnityEvent onExitCurrentTurn = null;
		public UnityEvent onEnterNextTurn = null;
		...
		void Start()
		{
			...
			else
			{
				...
				// //Events
				// onEnterNextTurn.Invoke();   //This should invoke UnitRegistry.RunUnitsBeginTurn()
			}
		}
		...
		/// </summary>
		public void InsertTurnState(State turnState)
		{
